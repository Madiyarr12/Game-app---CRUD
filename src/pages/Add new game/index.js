    ...
    <Layout>
     {
      ...
      <h1 className="text-4xl font-bold p-5 text-center">Add new game</h1>
            ...
            <ToastContainer
              ...
              pauseOnHover
            />
      </div> : <img className="h-[500px] mx-auto" src="https://static.vecteezy.com/system/resources/previews/002/416/499/non_2x/404-error-and-page-not-found-illustration-vector.jpg" alt=""/>
     }
    </Layout>
  );
}
